...
namespace MixedRemoteViewCompositor
{
    ...
    public class MrvcCapture : MonoBehaviour
    {
        ...
        private void CaptureStart()
        {
            ...
            Transform tAnchor = ShareManager.Instance.spawnManager.defaultParent.transform;
            ShareManager.Instance.SendSyncMessage(ShareManager.WORLD_ANCHOR, tAnchor.position, tAnchor.localRotation);
        }
