...
namespace MixedRemoteViewCompositor
{
    ...
    public class MrvcManager : MonoBehaviour
    {
        ...
        private GameObject vuforia = null;
        ...
        public MrvcPlayer playbackEngine;
            ...
            if (args.CurrentState == CaptureState.Closed && args.ConnectionState == ConnectionState.Closed)
            {
                this.plugin.QueueAction(() =>
                {
                    ...
                    if (vuforia != null)
                    {
                        ...
                        InfoDisplay.Instance.UpdateText("Stopping MRVC Capture, Vuforia: " + (vuforia != null) + " " + vuforia.activeSelf);
                    }
        ...
        public void PauseRemote(bool pause)
        {
            if(pause)
            {
                this.plugin.QueueAction(() =>
