...
namespace HoloToolkit.Sharing
{
    ...
    public class TransformSynchronizer : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                isEnabled.Value = updatedIsEnabled = thisRenderer;
            }
        }
        ...
        private void Update()
        {
            ...
            if (thisRenderer != null)
            {
                if (thisRenderer.enabled != isEnabled.Value && isEnabled.Value == updatedIsEnabled)
                {
                    isEnabled.Value = thisRenderer.enabled;
                    updatedIsEnabled = thisRenderer.enabled;
                }

                if (isEnabled.Value != thisRenderer.enabled && thisRenderer.enabled == updatedIsEnabled)
                {
                    thisRenderer.enabled = isEnabled.Value;
                    updatedIsEnabled = isEnabled.Value;
                }
            }
    }
