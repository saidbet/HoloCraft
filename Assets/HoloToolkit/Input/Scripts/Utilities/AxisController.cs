...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class AxisController : MonoBehaviour
    {
        ...
        private Vector3 KeyboardLookTick()
        {
            ...
            {
                rot.x += InputCurve(deltaTime * KeyboardSensitivity * GetKeyDir(KeyCode.A, KeyCode.E));
            }
            ...
            else if (axisType == AxisType.KeyboardQD)
            {
                rot.x += InputCurve(deltaTime * KeyboardSensitivity * GetKeyDir(KeyCode.Q, KeyCode.D));
            }
